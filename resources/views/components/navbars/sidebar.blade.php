...
<aside
    class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-2.5  fixed-start ms-1   bg-gradient-dark"
    id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0 d-flex text-wrap align-items-center" href=" {{ route('dashboard') }} ">
            ...
            <span class="ms-3 font-weight-bold text-white">Material Dashboard</span>
        </a>
    </div>
    <hr class="horizontal light mt-2 mb-0">
    <div class="  w-auto  max-height-vh-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'addcategory' ? ' active bg-gradient-primary' : '' }} "
            ...
            <li class="nav-item">
                    <a class="nav-link text-white {{ $activePage == 'addgallery' ? ' active bg-gradient-primary' : '' }} "
                        href="{{ route('AddGallery') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">table_view</i>
                        </div>
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'addmedia' ? ' active bg-gradient-primary' : '' }} "
                    href="{{ route('AddMedia') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">table_view</i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'managemedia' ? ' active bg-gradient-primary' : '' }} "
                    href="{{ route('ManageMedia') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">table_view</i>
                    </div>
                    <span class="nav-link-text ms-1">Manage Media</span>
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'AddShipping' ? ' active bg-gradient-primary' : '' }} "
                    href="{{route('shipping')}}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">table_view</i>
                    </div>
