<x-layout bodyClass="g-sidenav-show  bg-gray-200">
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            <!-- Navbar -->
            <x-navbars.navs.auth titlePage="Category Table"></x-navbars.navs.auth>
            <!-- End Navbar -->
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-center text-sm">
                                                    <span class="badge badge-sm bg-gradient-success">{{$cat->details}}</span>
                                                </td>
                                                ...
                                                <td class="align-middle">
                                                    <a class="btn btn-success btn-link"
                                                        href="{{route('geteditcategory', $cat->id)}}">
                                                        <i class="material-icons">edit</i>
                                                    </a>
                                                    <a  class="btn btn-danger btn-link"
                                                        href="{{route('getDeleteCategory', $cat->id)}}" >
